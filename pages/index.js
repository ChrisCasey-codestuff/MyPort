  ...
  return (
    ...
    <div data-aos="fade-up" data-aos-duration="1500" className="ml-12 mt-4">
      ...
      <p className="text-2xl opacity-0 animate-pulse">你好,</p>
        ...
        <p className="text-gray-400 text-2xl bg-slate ml-10 mt-10 w-5/6 mr-80 sm:mr-84 font-light leading-loose">I am a bilingual full stack software engineer and electronic musician. I specialize in building React and Javascript applications.
