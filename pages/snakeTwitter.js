  ...
  return (
    <main>
      ...
      <div data-aos="fade-right"  data-aos-duration="1000" className="flex flex-col sm:items-center sm:justify-center lg:items-start md:items-start">
        ...
        <p className="m-5 text-xl sm:text-center lg:text-left md:text-left text-gray-300 font-light tracking-wide w-2/3">Hiss is a twitter-like application built using Python, Django, postgreSQL, and TailwindCSS</p>
