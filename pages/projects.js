      ...
      <div className="flex flex-row items-end justify-end mt-5 mr-3 ml-2">
        <div className="mr-10">
          ...
          <div className="flex flex-row lg:justify-start md:justify-start mr-30 sm:justify-center">
            <div data-aos="fade-up" className="bg-black m-5 p-5 rounded-md border-2 border-gray-400 hover:border-gray-500 drop-shadow-md bg-transparent w-1/2 lg:text-left md:text-left sm:text-center">
