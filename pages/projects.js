    ...
    <main className="pl-5">
      ...
      <div className="flex flex-row items-end justify-end mt-5 mr-3 ml-2">
        <div className="lg:mr-10 md:mr-10 sm:mr-5">
          ...
          <div data-aos="fade-up"  data-aos-duration="1000" className="bg-black lg:m-5 md:m-5 sm:ml-5 sm:mt-5 sm:mr-5 p-5 rounded-md border-2 border-gray-400 hover:border-gray-500 drop-shadow-md bg-transparent lg:w-1/2 md:w-4/5 sm:w-4/5">
          ...
          <div className="flex flex-row lg:justify-start md:justify-start mr-30 sm:justify-center">
            <div data-aos="fade-up"  data-aos-duration="1000" className="bg-black lg:m-5 md:m-5 sm:ml-5 sm:mt-5 sm:mr-5 p-5 rounded-md border-2 border-gray-400 hover:border-gray-500 drop-shadow-md bg-transparent lg:w-1/2 md:w-4/5 sm:w-4/5 lg:text-left md:text-left sm:text-center lg:mr-40">
