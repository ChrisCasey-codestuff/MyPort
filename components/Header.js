...
function Header() {
  ...
  <header className="flex justify-between items-center h-auto w-auto bg-black">
     ...
     lg:mr-10 lg:z-50 md:z-50 sm:z-50 md:mt-5 sm:mt-0 sm:w-full md:w-auto lg:w-auto sm:pr-8 lg:pr-0 md:pr-0">
      <ul className="flex lg:flex-col lg:justify-start md:flex-col md:justify-start sm:flex-row sm:justify-center sm:pr-10 lg:pr-0 md:pr-0 sm:items-center sm:bg-black sm:w-full md:bg-transparent lg:bg-transparent md:w-auto lg:w-auto">
