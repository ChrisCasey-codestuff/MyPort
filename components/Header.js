...
function Header() {
  ...
  <header className="flex justify-between items-center h-auto w-auto bg-black">
     ...
     md:bg-none lg:mt-10 lg:bg-none fixed top-0 lg:right-0 md:right-0 sm:mr-80 md:mr-6 lg:mr-10 lg:z-50 md:z-50 sm:z-50 md:mt-10 sm:mt-0">
  ...
  <div className="flex flex-row justify-center mr-2">
    <a href="https://github.com/ChrisCasey-codestuff">
      <p data-aos="fade-right" data-aos-duration="1500" className="text-gray-400 border-2 border-black hover:text-gray-500 text-2xl mr-5 p-2 mt-12 font-extralight rounded-sm">GitHub</p>
    </a>
    <a href="https://www.linkedin.com/in/christopher-casey-se">
      <p data-aos="fade-down" data-aos-duration="1500" className="text-gray-400 border-2 border-black hover:text-gray-500 text-2xl mr-5 p-2 mt-12 font-extralight rounded-sm">LinkedIn</p>
    </a>
    <a href="/#contact">
      <p data-aos="fade-left" data-aos-duration="1500" className="text-gray-400 border-2 border-black hover:text-gray-500 text-2xl mr-5 p-2 mt-12 font-extralight rounded-sm">Contact</p>
    </a>
  </div>
  </section>
  )
